...
namespace Drupal\saibher_tracking\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\saibher_tracking\TrackingInterface;
 ...
 *   You can see this in the entity.saibher_tracking_tracking.canonical
 *   route in the saibher_tracking.routing.yml file. The view can be
 ...
 *
 * @ContentEntityType(
 *   id = "saibher_tracking_tracking",
 *   label = @Translation("Tracking entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\saibher_tracking\Entity\Controller\TrackingListBuilder",
 *     "form" = {
 *       "default" = "Drupal\saibher_tracking\Form\TrackingForm",
 *       "delete" = "Drupal\saibher_tracking\Form\TrackingDeleteForm",
 *     },
 *     "access" = "Drupal\saibher_tracking\TrackingAccessControlHandler",
 *   },
 *   list_cache_contexts = { "user" },
 *   base_table = "tracking",
 *   admin_permission = "administer tracking entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 *   },
 *   links = {
 *     "canonical" = "/saibher_tracking_tracking/{saibher_tracking_tracking}",
 *     "edit-form" = "/saibher_tracking_tracking/{saibher_tracking_tracking}/edit",
 *     "delete-form" = "/tracking/{saibher_tracking_tracking}/delete",
 *     "collection" = "/saibher_tracking_tracking/list"
 *   },
 *   field_ui_base_route = "saibher_tracking.tracking_settings",
 * )
 *
 ...
 *
 * Example: 'entity.saibher_tracking_tracking.canonical'.
 *
 * See the routing file at saibher_tracking.routing.yml for the
 * corresponding implementation.
 *
 * The Tracking class defines methods and fields for the tracking entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see TrackingInterface) also exposes the EntityOwnerInterface.
 ...
 */
class Tracking extends ContentEntityBase implements TrackingInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Tracking entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Tracking entity.'))
      ->setReadOnly(TRUE);

    // Name field for the tracking.
    ...
    $fields['first_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The first name of the Tracking entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
